...
class VirtualStation {
     ...
     * @param {string} countryZone (optional) representing the country of the city. list of available country codes here: https://timezonedb.com/time-zones
     */
    constructor(name, id, countryZone){
        this.sensors = {};
        this.name = name;
        this.id = id;
